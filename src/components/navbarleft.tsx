...
export default function NavbarLeft() {
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-[#111c44] to-[#081229] text-white cp-4 p-2 ">
      <div className="flex item-center space-x-2 text-lg font-bold mt-4">
        <Image
          src="/logo-dark.svg"
          alt="Logo Cover"
          width={150}
      ...
      <nav className="mt-6 flex-grow pl-3">
      ...
      <div className="mt-4 pt-4 border-t border-gray-700 pl-3">
